...
async function renderViolations() {
  ...
  shell(`${form}<div class="card" style="margin-top:16px"><div class="toolbar"><h3 style="margin-right:auto">Danh sách vi phạm</h3>${can('can_export') ? '<button class="btn secondary" data-export="violations">Tải Excel</button>' : ''}</div>${list}</div>`, 'Vi phạm', 'Danh mục và mức xử lý theo SOP chế tài; nhân viên chỉ xem vi phạm của mình');
